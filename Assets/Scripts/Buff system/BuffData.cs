...
//class that can  be used to create a basic buff on any EntityStats object. Will either heal
//or damage the owner and expires after a certain duration

[CreateAssetMenu(fileName = "Buff Data", menuName = "NewScriptables/Buff Data")]
public class BuffData : ScriptableObject
{
    ...
    [System.Flags]
    public enum Type : byte { buff = 1, debuff = 2} //you can add another type of you want
    public Type type;
    ...
    public class Stats
    {
        ...
        [Tooltip("The tint color of units affected by this buff")]
